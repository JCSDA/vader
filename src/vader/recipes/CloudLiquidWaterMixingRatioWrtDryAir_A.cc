...
void CloudLiquidWaterMixingRatioWrtDryAir_A::executeNL(atlas::FieldSet & afieldset)
{
    oops::Log::trace()
        << "entering and exiting empty CloudLiquidWaterMixingRatioWrtDryAir_A::executeNL function"
        << std::endl;
}
